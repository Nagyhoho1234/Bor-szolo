...
_ENSEMBLE_SUBDIR = os.environ.get("ENSEMBLE_SUBDIR", "")
INTERIM = ANALYSIS / "interim" / _ENSEMBLE_SUBDIR if _ENSEMBLE_SUBDIR else ANALYSIS / "interim"
DAILY_DIR = INTERIM / "daily"
WEIGHTS_NPZ = (ANALYSIS / "interim" / "district_weights.npz")  # grid-specific, shared across members
